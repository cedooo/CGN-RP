 ...
 *
 */
public final class LKClient extends RPClient{
	@Override
	...
	private boolean getRealTimeData(){
		...
		this.realTimeDataSet = 
				SocketConnetionContainer.getRealData(this.roomInterfaceCof.getCompanyCode());
		log.info("数据大小：" + realTimeDataSet.size() + ", 取得实时数据完成");
